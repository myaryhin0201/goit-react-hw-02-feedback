!(function (e) {
  function r(r) {
    for (
      var n, a, f = r[0], l = r[1], c = r[2], p = 0, s = [];
      p < f.length;
      p++
    )
      (a = f[p]),
  ...
  (a.m = e),
    ...
    (a.p = '/goit-react-hw-02-feedback/');
  var f = (this.webpackJsonpfeedback = this.webpackJsonpfeedback || []),
    l = f.push.bind(f);
  (f.push = r), (f = f.slice());
...
//# sourceMappingURL=runtime-main.3c0361d5.js.map
